...
use workspace_manager_b\Helpers as Helpers;
use workspace_manager_b\PathObject as PathObject;

class contentExtensionWorkspace_manager_cEditorframe extends HTMLPage
{
