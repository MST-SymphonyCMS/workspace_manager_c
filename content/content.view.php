...
require_once EXTENSIONS . '/workspace_manager_c/lib/class.path_object.php';

use workspace_manager_c\Helpers as Helpers;
use workspace_manager_c\PathObject as PathObject;

class contentExtensionWorkspace_manager_cView extends AdministrationPage
{
    ...
    {
        self::$assets_base_url = URL . '/extensions/workspace_manager_c/assets/';
        parent::__construct();
    ...
    public function __viewManager()
    {
        ...
        ob_start();
        include EXTENSIONS . '/workspace_manager_c/content/tmpl.indexview.uploads.php';
...
/*                              if(preg_match('/\/$/', $name) == 1){
    ...
    */
    public function __viewEditor()
    {
        ...
        $filepath = EXTENSIONS . '/workspace_manager_c/assets/highlighters/';
