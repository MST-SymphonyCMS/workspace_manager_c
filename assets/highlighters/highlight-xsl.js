(function ($) {
    ...
    var regexp = {
        'tag_start': /(<!--|<\?|<!\[CDATA\[|<\/?)/,
        'tag_end': /\/?>/,
        'xsl_tag_name': /^xsl:(apply-templates|attribute|call-template|choose|comment|copy-of|for-each|if|import|include|otherwise|output|param|stylesheet|template|text|value-of|variable|when|with-param)/,
    ...
    Symphony.Extensions.WorkspaceManager.highlighters['xsl'] = {
